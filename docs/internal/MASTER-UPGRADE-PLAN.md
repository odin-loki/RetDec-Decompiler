...
| D7 | Product positioning: pseudocode decompiler, or specification-extraction tool? | **Settled — (b) specification-extraction** ([docs/internal/D7_DECISION.md](D7_DECISION.md)) |
