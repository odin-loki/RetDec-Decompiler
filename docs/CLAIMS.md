...
| C-B10 | Third-party binaries labelled from upstream source | `RETDEC_AUDIT.md` B10 | `scripts/build_third_party_corpus.sh` (zlib 1.3.1 pin); `results/b10-third-party.md`. Decompile timed out (300s). Not coreutils/OpenSSL/SQLite. | demonstrated |
