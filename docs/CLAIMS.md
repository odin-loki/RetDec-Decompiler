...
| C-B8-LOOP | Loop-containing negatives; FP rate on strlen/atoi/dfs/sort heuristics | `RETDEC_AUDIT.md` B8 leftover | `scripts/ci/run_b8_loop_negatives.sh`; `results/b8-loop-negatives.md`. After sort gates + RingBuffer wrap-mask, FP **0.100** (10/100 HTTP-verb copy). Not a product figure. | demonstrated |
