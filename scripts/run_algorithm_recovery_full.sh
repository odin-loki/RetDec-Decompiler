...
JOBS=4
MIN_DECOMPILED=180
# Official gate is name-blind mean_f1 on the full corpus (measured 0.056).
# Stem-era 0.95 is not the product metric (CI-01). Do not delete --stem-fallback.
MIN_MEAN_F1=0.05
MIN_MEAN_F1_RAW=0.05
