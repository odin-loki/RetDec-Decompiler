...
// ─── Steensgaard actually unifies ────────────────────────────────────────────

// propagate() unified only the points-to *targets* and never the pointers, and
// alias() asked only whether the pointers were unified. Between them, no pair
