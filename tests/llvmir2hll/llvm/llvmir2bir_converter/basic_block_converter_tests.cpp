/**
* @file tests/llvmir2hll/llvm/llvmir2bir_converter/basic_block_converter_tests.cpp
...
* @brief Tests for the @c basic_block_converter module.
*/
class BasicBlockConverterTests: public LLVMIR2BIRConverterBaseTests {};
...
FunctionCallWithUsedResultIsConvertedCorrectlyAsAssignStmtWithCallExprInRhs) {
	...
	auto retStmt = cast<ReturnStmt>(varDefStmt->getSuccessor());
	ASSERT_TRUE(retStmt);
