...
def test_tagged_vector_excluded_from_headline() -> None:
    cfg = {
        "functions": [
            {
                "semanticDetections": [
                    {
                        ...
                        "confidence": 0.80,
                        "detail": "evidence:symbol_name std::vector",
                    },
                    {"kind": "sort", "label": "heap sort", "confidence": 0.9},
                ]
            }
    ...
    assert "Vector" not in labels
    assert "HeapSort" in labels


def test_tagged_list_excluded_from_headline() -> None:
    cfg = {
        "functions": [
            {
                "semanticDetections": [
                    {
                        ...
                        "label": "std::list<int>",
                        "confidence": 0.80,
                        "detail": "evidence:symbol_name std::list",
                    },
                    {"kind": "sort", "label": "heap sort", "confidence": 0.9},
                ]
            }
...
def test_tagged_shared_ptr_excluded_from_headline() -> None:
    cfg = {
        "functions": [
            {
                "semanticDetections": [
                    {
                        "kind": "container",
                        "label": "std::shared_ptr<T>",
                        "confidence": 0.80,
                        "detail": "evidence:symbol_name std::shared_ptr",
                    },
                    {"kind": "sort", "label": "heap sort", "confidence": 0.9},
                ]
            }
    ...
    labels = labels_from_config(cfg, "generated_heapsort-gcc-O0")
    assert "SharedPtr" not in labels
    assert "HeapSort" in labels
                ...
                "semanticDetections": [
                    {
                        ...
                        "label": "partition",
                        "confidence": 0.80,
                        "detail": "evidence:symbol_name std::partition",
                    },
                    {"kind": "sort", "label": "heap sort", "confidence": 0.9},
                ]
            }
                ...
                "semanticDetections": [
                    {
                        ...
                        "label": "heapsort",
                        "confidence": 0.80,
                        "detail": "evidence:symbol_name heapsort",
                    },
                    {"kind": "sort", "label": "introsort (std::sort)", "confidence": 0.9},
                ]
            }
        ]
    }
    labels = labels_from_config(cfg, "generated_introsort-gcc-O0")
    assert "HeapSort" not in labels
    assert "Introsort" in labels
