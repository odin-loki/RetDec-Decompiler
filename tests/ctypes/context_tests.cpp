...
public:
	ContextTests(): context(std::make_shared<Context>()), intType(IntegralType::create(context, "int", 32)) {}
...
TEST_F(ContextTests, AddFunctionCrashesOnNullptr)
{
	EXPECT_DEATH(context->addFunction(nullptr), "violated precondition - function cannot be null");
}
#endif

TEST_F(ContextTests, HasFunctionWithNameReturnsTrueWhenFunctionIsThere)
{
...
TEST_F(ContextTests, HasFunctionWithNameReturnsFalseWhenFunctionIsNotThere)
{
	EXPECT_FALSE(context->hasFunctionWithName("someF"));
}

TEST_F(ContextTests, GetFunctionWithNameReturnsCorrectFunction)
{
	auto newF = Function::create(context, "newF", intType, params);
...
TEST_F(ContextTests, GetFunctionWithNameReturnsNullptrWhenFunctionNotThere)
{
	EXPECT_EQ(nullptr, context->getFunctionWithName("myF"));
}

#if DEATH_TESTS_ENABLED
TEST_F(ContextTests, AddNamedTypeCrashesOnNullptr)
{
	EXPECT_DEATH(context->addNamedType(nullptr), "violated precondition - type cannot be null");
}
#endif

TEST_F(ContextTests, HasNamedTypeReturnsTrueWhenTypeIsThere)
{
...
TEST_F(ContextTests, HasNamedTypeReturnsFalseWhenTypeIsNotThere)
{
	EXPECT_FALSE(context->hasFunctionWithName("my_int"));
}

TEST_F(ContextTests, GetNamedTypeReturnsCorrectType)
{
	auto newT = IntegralType::create(context, "int", 32);
...
TEST_F(ContextTests, GetNamedTypeReturnsNullptrWhenTypeNotThere)
{
	EXPECT_EQ(nullptr, context->getNamedType("myF"));
}

TEST_F(ContextTests, HasFunctionTypeReturnsTrueWhenTypeIsThere)
{
...
TEST_F(ContextTests, HasArrayTypeReturnsTrueWhenTypeIsThere)
{
...
TEST_F(ContextTests, HasPointerTypeReturnsTrueWhenTypeIsThere)
{
...
TEST_F(ContextTests, AddFunctionKeepsFirstOne)
{
...
TEST_F(ContextTests, AddNamedTypeKeepsFirstOne)
{
