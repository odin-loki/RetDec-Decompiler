...
// Stop the OrderedAllVisitor recursion at dereferences and casts.
// A pattern like v1 = *(uint64_t *)(v1 + 8) must NOT become v1 += 8 because
// the variable appears inside a load or cast, not as the direct accumulator.
void CompoundOpManager::visit(ShPtr<DerefOpExpr>) {}
void CompoundOpManager::visit(ShPtr<BitCastExpr>) {}
void CompoundOpManager::visit(ShPtr<ExtCastExpr>) {}
void CompoundOpManager::visit(ShPtr<TruncCastExpr>) {}
void CompoundOpManager::visit(ShPtr<FPToIntCastExpr>) {}
void CompoundOpManager::visit(ShPtr<IntToFPCastExpr>) {}
void CompoundOpManager::visit(ShPtr<IntToPtrCastExpr>) {}
void CompoundOpManager::visit(ShPtr<PtrToIntCastExpr>) {}
