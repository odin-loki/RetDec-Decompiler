...
//
	protected:
		...
		void translateCasp(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		void translateSysRegMove(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		void translateNeonFpCmp(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateNeonTbl(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		void translateNeonSatArith(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateNeonAddhn(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		void translateNeonIns(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateNeonLdR(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateNeonMla(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateNeonAddlp(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		void translateStxr(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateStxp(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		void translateFence(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		void translateFMla(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		...
		// ARM64 FP rounding and convert extensions (arm64_fp_ext.cpp)
		void translateFRint(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateFCvtRound(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateFCvtVec(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateFAddP(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateFMulX(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateFMinMaxP(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
		void translateFCmpE(cs_insn* i, cs_arm64* ai, llvm::IRBuilder<>& irb);
};
