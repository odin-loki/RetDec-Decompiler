...
//
	protected:
		...
		void translateSseAddPs(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSseMulPs(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSseDivPs(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
