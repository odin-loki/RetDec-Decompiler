...
//
	protected:
		...
		void translateBitCount(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateAndn(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateBls(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		...
		// SSE/XMM instruction translations (x86_sse.cpp)
		void translateSseMovWhole(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSseMovLane0(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateMovLhps(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateMovHlps(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateMovDdup(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateMovShDup(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSsePadd(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSsePsub(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSsePand(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSsePandn(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		...
		void translateSseHorizontal(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSseFltArith(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		...
		void translateSseCvtFlt(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateCvtTt2Si(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		...
		void translateSsePackedShift(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSseMovWiden(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSseSaturatingArith(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
		void translateSsePack(cs_insn* i, cs_x86* xi, llvm::IRBuilder<>& irb);
