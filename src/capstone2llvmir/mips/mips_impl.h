...
//
	protected:
		...
		bool isMsaModelledId(uint32_t id) const;
...
//
	protected:
		...
		void translateJic(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateLi(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateAddiupc(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateAui(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateAddiusp(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateJraddiusp(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateBitswap(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateAlign(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateLwpc(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateLoadPair(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateStorePair(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateLoadMultiple(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateStoreMultiple(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaAddv(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaSubv(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaMulv(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaIlv(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaShf(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaSplat(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaMaxs(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaMins(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaSll(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaSrl(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaLogiB(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaPck(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaBsel(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaBseli(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaCmp(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaSatArith(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaSat(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaSld(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaFbin(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaCopy(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaInsert(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaFill(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateMsaLdi(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateSeleqz(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateSelnez(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		void translateSel(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
		...
		void translateDoubleShift32(cs_insn* i, cs_mips* mi, llvm::IRBuilder<>& irb);
