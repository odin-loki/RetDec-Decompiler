/**
 * @file src/bin2llvmir/providers/abi/sparc.cpp
...
AbiSparc::AbiSparc(llvm::Module* m, Config* c) :
		Abi(m, c)
{
	...
	// CC_SPARC is added in the wiring commit (docs/internal/wire-sparc.md).
	_defcc = CallingConvention::ID::CC_UNKNOWN;
}

bool AbiSparc::isGeneralPurposeRegister(const llvm::Value* val) const
{
...
bool AbiSparc::isNopInstruction(cs_insn* insn)
{
