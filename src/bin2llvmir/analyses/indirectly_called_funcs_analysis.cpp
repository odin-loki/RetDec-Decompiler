...
std::set<llvm::Function*> IndirectlyCalledFuncsAnalysis::getFuncsForIndirectCalls(
	const std::set<llvm::CallInst*>& call, Module::FunctionListType& funcsToCheck)
{
	...
	{
		addToSet(getFuncsForIndirectCall(*callInst, funcVec), indirectlyCalledFuncs);
	}
...
std::set<llvm::Function*> IndirectlyCalledFuncsAnalysis::getFuncsForIndirectCall(
	const CallInst& call, const std::vector<llvm::Function*>& funcsToCheck)
{
