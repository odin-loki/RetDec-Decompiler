...
bool PluginManager::validateApiVersion(const QString& filePath, QPluginLoader& loader) const
{
	(void)loader;
...
{
	QStringList searchPaths = paths.isEmpty() ? AppSettings::instance().plugins.searchPaths : paths;
