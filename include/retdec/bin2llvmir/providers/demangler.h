...
public:
	...
	/// Stage 14: Type-seeding — get LLVM function type from demangled name for type inference
	llvm::FunctionType* getFunctionTypeFromDemangledName(const std::string &mangled);
