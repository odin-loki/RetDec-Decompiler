...
class CallingConvention
{
	public:
		...
		CC_POWERPC64,
		CC_PIC32,
		/// Microsoft __vectorcall — integer args in ECX/EDX (x86) or RCX/RDX
		/// (x64); vector/float args passed in XMM0-5.
		CC_VECTORCALL,
		/// Intel __regcall — maximises register usage for all argument types.
		CC_REGCALL,
		CC_ENDING,
		};
