...
class Heuristics
{
	private:
		...
		/// @name Structural entropy packer detection (Stage 2)
		/// @{
		void getStructuralEntropyHeuristics();
		/// @}

		/// @name Codegen compiler fingerprinting (Stage 4)
		/// @{
		void getCodegenFingerprintHeuristics();
		/// @}
