...
public:
	...
	QStackedWidget* centralStackForTest() const
	{
		return centralStack_;
	}

	/// Central document tab widget.
	QTabWidget* documentTabsForTest() const
	{
		return documentTabs_;
	}
	QTabWidget* outputTabsForTest() const
	{
		return outputTabs_;
	}
	QTabWidget* workspaceTabsForTest() const
	{
		return workspaceTabWidget_;
	}
	panels::LiveConsolePanel* liveConsoleForTest() const
	{
		return liveConsole_;
	}
	panels::TriageBanner* triageBannerForTest() const
	{
		return triageBanner_;
	}
	QDockWidget* outputDockForTest() const
	{
		return dockOutput_;
	}
	QDockWidget* symbolsDockForTest() const
	{
		return dockFunctions_;
	}
	QDockWidget* workspaceDockForTest() const
	{
		return dockWorkspace_;
	}
	...
	qint64 lastDecompileSubprocessMsForTest() const
	{
		return lastDecompileSubprocessMs_;
	}
...
private:
	...
	bool loadDecompileArtifacts(const QString& decompiledCPath, std::optional<uint64_t> reselectAddress = std::nullopt);
