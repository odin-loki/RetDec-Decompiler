...
struct RecoveryConfidence
{
	...
	{
		return typeInference * 0.30f + structure * 0.30f + variable * 0.20f + algorithm * 0.20f;
	}
};
...
public:
	...
	const std::vector<FunctionEntry>& functions() const
	{
		return fns_;
	}
...
class FunctionPatternDelegate : public QStyledItemDelegate {
	Q_OBJECT
public:
	explicit FunctionPatternDelegate(FunctionListModel* model, QObject* parent = nullptr);

	void paint(QPainter*, const QStyleOptionViewItem&, const QModelIndex&) const override;
	QSize sizeHint(const QStyleOptionViewItem&, const QModelIndex&) const override;

private:
	void paintConfidence(QPainter*, const QStyleOptionViewItem&, float confidence) const;
	void paintPatterns(QPainter*, const QStyleOptionViewItem&, const PatternFlags&) const;
...
class FunctionFilterProxy : public QSortFilterProxyModel {
	Q_OBJECT
public:
	explicit FunctionFilterProxy(FunctionListModel* model, QObject* parent = nullptr);
