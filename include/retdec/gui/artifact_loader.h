...
struct DecompileArtifacts
{
	...
	std::vector<panels::ConstantEntry> constants;
...
bool loadDecompileArtifactsFromPaths(
	const DecompileArtifactPaths& paths, DecompileArtifacts& out, QString* errOut = nullptr);

QString
extractDsmForFunction(const QString& fullDsm, uint64_t startAddr, uint64_t endAddr, const QString& funcName = {});
