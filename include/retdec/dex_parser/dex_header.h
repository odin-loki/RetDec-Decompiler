...
public:
	explicit DexParseError(const std::string& msg): std::runtime_error("DEX parse error: " + msg) {}
};
...
struct DexHeader
{
	...
	{
		return endianTag == kEndianConstSwap;
	}
};
