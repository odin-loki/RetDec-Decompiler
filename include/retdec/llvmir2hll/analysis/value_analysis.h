...
public:
	...
	/// Returns the alias analysis used by this value analysis.
	/// The returned object is read-only after initAliasAnalysis() has been
	/// called and is safe to share across threads.
	ShPtr<AliasAnalysis> getAliasAnalysis() const { return aliasAnalysis; }
